        ...
        if counters:
            for i in counters:
                ...
                CounterYears.objects.create(
                    ...
                    b4=round(aggregate_qs['b4']),
                    b5=round(aggregate_qs['b5']),
                    b6=round(aggregate_qs['b6']),
                    b7=round(aggregate_qs['b7']),
                    b10=round(aggregate_qs['b10']),
                    gumus=round(aggregate_qs['gumus']),
                    fosfor=round(aggregate_qs['fosfor']),
                    kaliy=round(aggregate_qs['kaliy']),
                    shorlanish=round(aggregate_qs['shorlanish']),
