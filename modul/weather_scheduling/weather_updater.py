...
def counter_year():
    ...
    scheduler.add_job(counter_year.avg_year_counter, 'cron', month='1', day='19', hour='16', minute=26,
...
def counter_month():
    ...
    scheduler.add_job(counter_month.avg_monthly_counter, 'cron', day='1', hour='0', minute="30",
                      timezone='Asia/Tashkent',
