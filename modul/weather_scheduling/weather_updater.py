...
def counter_season():
    ...
    scheduler.add_job(counter_season.avg_season_counter, 'cron', month='3,6,9,12', day='1', hour='2', minute=20,
                      timezone='Asia/Tashkent',
...
def counter_month():
    ...
    scheduler.add_job(counter_month.avg_monthly_counter, 'cron', day='2', hour='10', minute="53",
                      timezone='Asia/Tashkent',
