...
def counter_season():
    ...
    scheduler.add_job(counter_season.avg_season_counter, 'cron', month='3,6,9,12', day='1', hour='3', minute=3,
                      timezone='Asia/Tashkent',
...
def counter_month():
    ...
    scheduler.add_job(counter_month.avg_monthly_counter, 'cron', day='17', hour='19',minute=27, timezone='Asia/Tashkent',
