...
def start():
    ...
    scheduler.add_job(weather.get_weekly_weather, 'cron', hour=0, minute=0, second=0, timezone='Asia/Tashkent',
...
def start2():
    scheduler = BackgroundScheduler()
    weather = WeatherViewSet()
    scheduler.add_job(weather.get_hourly_weather, 'cron', hour=0, minute=0, second=0, timezone='Asia/Tashkent',
...
def counter_season():
    ...
    scheduler.add_job(counter_season.avg_season_counter, 'cron', month='5,6,9,12', day='23', hour='13', minute=20,
                      timezone='Asia/Tashkent',
...
def counter_month():
    ...
    scheduler.add_job(counter_month.avg_monthly_counter, 'cron', day='1', hour='1', minute="20",
                      timezone='Asia/Tashkent',
